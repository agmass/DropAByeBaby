...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("DropAByeBaby", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("DropAByeBaby", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "DropAByeBaby";
		app.meta["name"] = "DropAByeBaby";
